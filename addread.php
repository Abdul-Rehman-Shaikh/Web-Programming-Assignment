<?php
    ...
    try {
        ...
        if($count === 0) {
            $insert_statment = "insert into blogpostreads(post_id, user_id)
...
<body>
    <?php if($count === 1):  ?>
        <h1><?= "This post is already set to READ" ?></h1>
    <?php else: ?>
        <h1>
            <?= "This post has been successfully included in your READ collection" ?>
        </h1>
    <?php endif; ?>
